...
ใช้ Double ตามชนิดข้อมูลในใบงาน ตัวอย่างนี้เน้นเรียน Transaction ยังไม่ได้ออกแบบรองรับการฝากพร้อมกันหลายคำขอ และระบบเงินจริงควรใช้ BigDecimal

## ก่อนส่ง

- เติมชื่อและรหัสนักศึกษาในรายงาน
- เก็บภาพ Postman และ pgAdmin ตามใบงาน แล้วใส่ในรายงาน
- ตรวจว่าโค้ดกลับมาใช้ @Transactional และปิด throw แล้ว
- อัปโหลดโปรเจกต์และรายงานขึ้น GitHub ของตัวเอง แล้วนำลิงก์ไปส่ง
- อย่าอัปโหลดรหัสผ่านจริง ใช้ DB_PASSWORD แทน
